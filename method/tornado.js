// Ð½Ñƒ Ð¼Ð¸Ñ‚ÐµÐ½ÑŒÐºÐ° Ñ‚Ð¾Ñ‡Ð½Ð¾ Ð¿Ð¾ Ð²ÐµÐ½Ðµ ÑˆÐ²Ñ‹Ñ€Ð½ÑƒÐ» ?  // @rapidreset daite 2000$
    ...
    const netSocket = net.connect(Number(proxyPort), proxyHost, () => {
        netSocket.once('data', async () => {
            tlsSocket = tls.connect({
                ...
                secure: true,
                minVersion: 'TLSv1.3', // Ð£ÑÑ‚Ð°Ð½Ð°Ð²Ð»Ð¸Ð²Ð°ÐµÐ¼ Ð¼Ð¸Ð½Ð¸Ð¼Ð°Ð»ÑŒÐ½ÑƒÑŽ Ð²ÐµÑ€ÑÐ¸ÑŽ TLS 1.3
                maxVersion: 'TLSv1.3', // ÐžÐ³Ñ€Ð°Ð½Ð¸Ñ‡Ð¸Ð²Ð°ÐµÐ¼ Ð¸ÑÐ¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ð½Ð¸Ðµ Ñ‚Ð¾Ð»ÑŒÐºÐ¾ TLS 1.3
                session: crypto.randomBytes(64),
                compression: true,
                rejectUnauthorized: true, // Ð’ÐºÐ»ÑŽÑ‡Ð°ÐµÐ¼ Ð¿Ñ€Ð¾Ð²ÐµÑ€ÐºÑƒ ÑÐµÑ€Ñ‚Ð¸Ñ„Ð¸ÐºÐ°Ñ‚Ð¾Ð²
                honorCipherOrder: false, // Ð¡Ð»ÐµÐ´ÑƒÐµÐ¼ ÑƒÑÑ‚Ð°Ð½Ð¾Ð²Ð»ÐµÐ½Ð½Ð¾Ð¼Ñƒ Ð¿Ð¾Ñ€ÑÐ´ÐºÑƒ ÑˆÐ¸Ñ„Ñ€Ð¾Ð²
                requestOCSP: true, // Ð’ÐºÐ»ÑŽÑ‡Ð°ÐµÐ¼ Ð¿Ñ€Ð¾Ð²ÐµÑ€ÐºÑƒ Ð¾Ñ‚Ð·Ñ‹Ð²Ð° ÑÐµÑ€Ñ‚Ð¸Ñ„Ð¸ÐºÐ°Ñ‚Ð¾Ð² Ñ‡ÐµÑ€ÐµÐ· OCSP
            }, () => {
